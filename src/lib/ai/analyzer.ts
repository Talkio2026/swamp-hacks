...
function parseAnalysisResponse(response: string, modelUsed: string, processingTimeMs: number): AnalysisResult {
  ...
  try {
    ...
    return {
      ...
      scheduledMeeting: parsed.scheduledMeeting ? {
        detected: parsed.scheduledMeeting.detected || false,
        date: parsed.scheduledMeeting.date,
        time: parsed.scheduledMeeting.time,
        duration: parsed.scheduledMeeting.duration,
        type: parsed.scheduledMeeting.type,
        notes: parsed.scheduledMeeting.notes,
      } : { detected: false },
      analyzedAt: new Date(),
      modelUsed,
      processingTimeMs,
