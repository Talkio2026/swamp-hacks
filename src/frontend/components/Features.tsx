...
const FEATURES = [
  {
    ...
    icon: (
      <svg className="h-8 w-8 text-[#7D9AB3]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden>
          ...
          {FEATURES.map(({ title, body, icon }) => (
            <article
              ...
              className={cn(
                ...
                'hover:border-[#9AAFC2] hover:bg-white hover:shadow-xl hover:shadow-[#7D9AB3]/15 hover:-translate-y-1'
              )}
            >
              <div className="mb-4 flex items-start justify-between">
                <span className="rounded-lg bg-[#E9EDF1] p-2">{icon}</span>
              </div>
