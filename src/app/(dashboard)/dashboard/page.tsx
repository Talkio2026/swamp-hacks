      ...
      <div className="flex-1 p-8 space-y-8 overflow-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="rounded-xl border border-[#E0E7FF] bg-white shadow-sm self-start">
            <div className="px-4 py-3 border-b border-[#E0E7FF]">
              <h2 className="text-base font-semibold text-[#1E1B4B]">Quick Actions</h2>
            </div>
            <div className="p-3 space-y-2">
              <Link 
                href="/clients"
                className="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-[#F5F7FA] transition-colors group"
              >
                ...
                <div>
                  <p className="text-sm font-medium text-[#1E1B4B] group-hover:text-[#4F46E5] transition-colors">Clients</p>
                  <p className="text-xs font-semibold text-[#4338CA]">Manage prospects</p>
                </div>
              </Link>
              ...
              >
                ...
                <div>
                  <p className="text-sm font-medium text-[#1E1B4B] group-hover:text-[#4F46E5] transition-colors">Playbooks</p>
                  <p className="text-xs font-semibold text-[#4338CA]">Sales strategies</p>
                </div>
              </Link>
              ...
              >
                ...
                <div>
                  <p className="text-sm font-medium text-[#1E1B4B] group-hover:text-[#4F46E5] transition-colors">Training</p>
                  <p className="text-xs font-semibold text-[#4338CA]">Practice sessions</p>
                </div>
              </Link>
            </div>
          </div>
