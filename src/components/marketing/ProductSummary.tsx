...
export function ProductSummary() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative px-6 py-8 lg:px-8 lg:py-12"
    >
        ...
        <div className="core-features-container">
          <div className="grid gap-6 sm:grid-cols-2">
            {CORE_FEATURES.map((feature) => (
              ...
              >
                <div className={cn(
                  "flex gap-4 p-6 rounded-2xl border border-purple-200/60 bg-white/80 backdrop-blur-sm shadow-sm transition-all duration-200",
                  "hover:border-purple-300/60 hover:shadow-md"
                )}>
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <span className="text-xs font-bold text-purple-600">{feature.number}</span>
